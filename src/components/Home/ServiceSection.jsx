...
const services = [
  {
    ...
    desc: `Enhances privacy and reduces heat inside your vehicle.`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "Vehicle Wrapping",
    desc: `Transforms your car’s look with protective vinyl film.
​`,
    image: "/gray.avif",
  ...
  },
  {
    ...
    desc: `Restores damaged wheels to a fresh, like-new finish.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[80%] rounded-2xl mt-25 mx-auto h-25 object-cover"
                    onError={(e) => {
                      e.currentTarget.onerror = null;
                      e.currentTarget.src = "/s1.png"; // fallback logo
                    }}
                  />
